...
In the first class, we'll continue talking about lists, then we'll move on to
tuples. We'll also look into how to import and define modules, as well as how
to download packages and build a project using Stack.
